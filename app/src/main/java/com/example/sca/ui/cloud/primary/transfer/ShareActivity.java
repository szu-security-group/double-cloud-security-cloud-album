...
import static com.example.sca.ui.cloud.primary.object.ObjectActivity.ACTIVITY_EXTRA_IMAGE_NAME;
...
import com.example.sca.ui.cloud.utils.encryptalgorithm.utils.HexStringAndByte;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbeDecryptionException;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbeEncrypted;
...
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.Cpabe;
        ...
        if (cosxmlTask2 == null) {
            ...
            cosxmlTask2.setCosXmlResultListener(new CosXmlResultListener() {
                ...
                public void onSuccess(CosXmlRequest request, CosXmlResult result) {
                    ...
                    // 将加密原图解密并保存
                    try {
                        savepath =  aesUtils.decryptCTRFile(downloadPath + "cos_download_" + filename,filename);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
