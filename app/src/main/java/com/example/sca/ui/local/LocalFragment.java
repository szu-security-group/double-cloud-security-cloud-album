...
import com.example.sca.ui.cloud.primary.AuditActivity;
...
public class LocalFragment extends Fragment implements itemClickListener {
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        inflater.inflate(R.menu.audit, menu);
        menu.findItem(R.id.audit).setVisible(true);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.audit)
        {
            Intent intent = new Intent(requireActivity(), AuditActivity.class);
