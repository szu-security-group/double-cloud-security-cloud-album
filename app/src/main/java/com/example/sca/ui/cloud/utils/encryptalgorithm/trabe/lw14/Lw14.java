package com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.lw14;

import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbeDecryptionException;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbeEncryptionException;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbePrivateKey;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbePublicKey;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbeSecretMasterKey;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbeSettings;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.AbeUserIndex;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.ElementVector;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.Pair;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.lw14.policy.LsssMatrix;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.lw14.policy.Lw14PolicyAbstractNode;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.lw14.policy.Lw14TreePreprocessing;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.matrixElimination.ElementField;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.matrixElimination.Matrix;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.policy.PolicyParsing;
import com.example.sca.ui.cloud.utils.encryptalgorithm.trabe.policyparser.ParseException;
    ...
    private static ArrayList<Lw14PrivateKeyComponent> generateAdditionalAttributes(AbeSecretMasterKey msk,
        ...
        if(msk.b==null){
            for (int i = 0; i < attributes.length; i++) {
                Element b1 = p.getZr().newRandomElement();
                Element gquote = p.getG1().newRandomElement().duplicate().powZn(b1);
                ...
                Element k1Tilde_ijx = pub.g.duplicate().powZn(b1.duplicate().mul(deltaQuoteIjx));
                Element k2Tilde_ijx = gquote.duplicate().powZn(x).mul(pub.h.duplicate().powZn(b1))
                        .powZn(deltaQuoteIjx);
                components
